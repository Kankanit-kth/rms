        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-3" style="max-width: 900px;">
                ...
                <ol class="breadcrumb justify-content-center text-white mb-0 wow fadeInDown" data-wow-delay="0.3s">
                    ...
                    <li class="breadcrumb-item active text-secondary">กลุ่มนวัตกรรม</li>
                </ol>    
            </div>
        </div>
        <!-- Header End -->
            ...
            <div class="container py-5">
                ...
                <div class="row g-4">
                            ...
                            <div class="service-inner">
                                ...
                                <div class="service-title">
                                    ...
                                    <div class="service-content pb-4">
                                        <a href="#"><h4 class="text-white mb-4 py-3">สมุนไพร</h4></a>
                                        <div class="px-4">
                        ...
                        <div class="service-item">
                            <div class="service-inner">
                                ...
                                <div class="service-title">
                                    <div class="service-title-name">
                                        <div class="bg-primary text-center rounded p-3 mx-5 mb-4">
                                            <a href="#" class="h4 text-white mb-0">ข้าว / พืชไร่</a>
                                        </div> 
                                    </div>
                                    <div class="service-content pb-4">
                        ...
                        <div class="service-item">
                            <div class="service-inner">
                                ...
                                <div class="service-title">
                                    <div class="service-title-name">
                                        <div class="bg-primary text-center rounded p-3 mx-5 mb-4">
                                            <a href="#" class="h4 text-white mb-0">เทคโนยีอุสาหกรรม</a>
                                        </div> 
                                    </div>
                                    <div class="service-content pb-4">
                    ...
                    <div class="col-12 text-center">
                        <a class="btn btn-primary border-secondary rounded-pill py-3 px-5 wow fadeInUp" data-wow-delay="0.1s" href="#">แสดงเพิ่มเติม</a>
                    </div>
                </div>
            </div>
        </div>
